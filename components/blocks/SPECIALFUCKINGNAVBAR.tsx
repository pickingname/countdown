...
export default function SPECIALFUCKINGNAVBAR() {
  ...
  return (
    <nav
      className={`
        ...
        h-14 px-6 backdrop-blur-md text-black rounded-2xl 
      ...
      >
        <DropdownMenu modal={false} aria-label="progress bar from m1 to m3">
          ...
          >
            ...
            <Link href={"/board"} target="_top" aria-label="google">
              <DropdownMenuItem className="text-black">Board</DropdownMenuItem>
            </Link>
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
